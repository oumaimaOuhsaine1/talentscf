                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-sm">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span className="text-gray-700">Maîtriser les fondamentaux de la gestion des ressources humaines.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">⊙</span>
                                        <span className="text-gray-700">Optimiser le recrutement et l'intégration des talents.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-red-600 mt-1 flex-shrink-0">⊙</span>
                                        <span className="text-gray-700">Développer les compétences en gestion de la performance.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">⊙</span>
                                        <span className="text-gray-700">Gérer les aspects juridiques et administratifs RH.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">Recrutement et sélection</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">Gestion de la performance</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">Formation et développement</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">Gestion des carrières</span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">Gestion de la paie</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">Relations sociales</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-sm">
                                        <span className="text-[#0088cc] mt-1 flex-shrink-0">●</span>
                                        <span className="text-gray-700">GPEC et stratégie RH</span>
                                    </div>
                                </div>
                            </div>
                        </div>
